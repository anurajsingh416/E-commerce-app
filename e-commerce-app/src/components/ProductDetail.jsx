...
export default function ProductDetail() {
    ...
    return (
        <>
            {!product ? <div className="h-full grid place-items-center"><p className="">Loading...</p></div> :
                <div className=" mt-8">
                    <Link to="/products" className=" my-8 md:pl-10 lg:pl-10 flex items-center justify-start">
                    <FaArrowLeft size={24} />
                    ...
                    <div className='mx-auto mt-4 flex flex-col md:flex-row lg:flex-row justify-evenly max-w-6xl p-8'>
                        ...
                        <div className="text-left md:pl-10 lg:pl-10 p-2">
                            ...
                            <button onClick={handleCart} className='mt-8 transform bg-gray-900 text-white py-2 px-4 opacity-85 group-hover:opacity-100 transition-all duration-500'>Add To Cart</button>
                        </div>
